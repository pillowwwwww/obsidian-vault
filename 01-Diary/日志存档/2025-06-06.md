...
### 在服务器上跑实验！
1. **连接服务器**
	1.- `ssh liuchang@202.117.21.54 -p 22` 现在改名为94
	  用户名liuchang 密码liuchang123
	`conda activate FL`
2. **在服务器上部署Miniconda**
3. **实验前准备**
...
### pycharm解释器远程连接
#### 之前我在服务器上通过生成密钥，注册了自己的账号。然后在pycharm的python解释器远程连接服务器，设置如图所示。为什么这样就可以实现本地更新代码，服务器同步更新呢？
![[2092aacd37d1608f1ed9d958063203c-1.png]]
